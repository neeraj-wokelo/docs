...
<ParamField query="primary_company" type="string">
  ...
  Note: You cannot use both `company` and `primary_company` in the same request. Use `primary_company` to return only articles where the specified company is the main focus of the news.
</ParamField>
