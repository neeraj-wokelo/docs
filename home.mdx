  ...
  <div style={{ 
    ...
    <div style={{
      ...
      <div style={{
        ...
        <a href="https://playground.akta.pro" target="_blank" className="bg-black text-white dark:bg-white dark:text-black" style={{
          display: 'inline-flex',
          alignItems: 'center',
          gap: '8px',
          padding: '14px 24px',
...
>
  ...
  >
    MCP 
    <span className="text-gray-500 text-xs font-light ml-0.5 mb-0.5 rounded">coming soon</span>
  </a>
