---
title: "Job Posts API Overview"
description: "Live job listings — title, location, description, compensation, experience level, and extracted key skills."
...
<Note>
  The Job Posts API is available on **Subscription** and **Enterprise** plans only. Requests on the **Pay-as-you-go** plan will return a `403` error. See [Pricing](/getting-started/pricing) for plan details.
</Note>
