...
Aggregate open roles to see which functions and geographies a company is investing in — a proxy for where the business is heading.
...
Extract and rank `key_skills` across all open roles to understand what capabilities a company is building — useful for competitive intelligence and talent-market analysis.
