---
title: "Headcount Trends API Overview"
description: "Obtain total employee count, historical growth trends, and a functional breakdown of the workforce."
...
<Note>
  The Headcount Trends API is available on **Subscription** and **Enterprise** plans only. Requests on the **Pay-as-you-go** plan will return a `403` error. See [Pricing](/getting-started/pricing) for plan details.
</Note>
