---
title: "Website Traffic API Overview"
description: "Website traffic signals — engagement metrics, historical monthly visit estimates, and a breakdown of traffic by acquisition source."
...
<Note>
  The Website Traffic API is available on **Subscription** and **Enterprise** plans only. Requests on the **Pay-as-you-go** plan will return a `403` error. See [Pricing](/getting-started/pricing) for plan details.
</Note>
