---
title: "Product Reviews API Use cases"
...
Lets say we want to pull product reviews for Canva. First step would be to fetch the product_ids.
...
Include product_ids in the products parameter while making the API call.
