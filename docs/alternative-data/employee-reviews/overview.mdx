---
title: "Employee Review API Overview"
description: "Aggregated employee review signals — overall rating, eight dimension-level scores, and more."
...
<Note>
  The Employee Reviews API is available on **Subscription** and **Enterprise** plans only. Requests on the **Pay-as-you-go** plan will return a `403` error. See [Pricing](/getting-started/pricing) for plan details.
</Note>
