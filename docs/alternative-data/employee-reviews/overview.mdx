...
This is a synchronous GET API — pass a company identifier and optional pagination parameters (`limit` and `offset`) and receive the full response immediately. The response also reports the credits consumed by the request.
