---
title: "Social Posts API Overview"
description: "Social media posts published by a company — content type, text, publish date, paid/repost flags, an AI classification, and detailed engagement metrics."
...
<Note>
  The Social Posts API is available on **Subscription** and **Enterprise** plans only. Requests on the **Pay-as-you-go** plan will return a `403` error. See [Pricing](/getting-started/pricing) for plan details.
</Note>
