---
title: "News Signals API Overview"
description: "Fetch news articles enriched with AI summaries, event types, sentiment, industry tags, named entities, and company mentions, scoped by company, industry, open-ended query, or any other filter."
...
- **LLM pipeline enrichment** : use `full_text` as input to summarisation, classification, or embedding models, pre-filtered by `type_list` and `sentiment_list`
