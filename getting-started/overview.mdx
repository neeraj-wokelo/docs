...
<Columns cols={3}>
  <Column>
    ...
    <Card title="Employee Reviews" icon="star-half-stroke" href="/docs/alternative-data/employee-reviews/overview">
      Workplace sentiment scores, dimension-level ratings, and individual reviews
    </Card>

    <Card title="Social Posts" icon="thumbs-up" href="/docs/alternative-data/social-posts/overview">
      Company posts, content mix, and engagement metrics
    </Card>
  </Column>
  <Column>
    ...
    <Card title="Job Posts" icon="briefcase" href="/docs/alternative-data/job-posts/overview">
      Live job listings, locations, compensation, and key skills
    </Card>

    <Card title="Headcount Trends" icon="chart-line" href="/docs/alternative-data/headcount-trends/overview">
      Employee counts, growth rates, and hiring by function
    </Card>
  </Column>
  <Column>
    <Card title="Product Reviews" icon="star" href="/docs/alternative-data/product-reviews/overview">
      Ratings, pros, cons, reviews by product and more
    </Card>

    <Card title="Website Traffic" icon="chart-simple" href="/docs/alternative-data/website-traffic/overview">
      Visit estimates, engagement metrics, and traffic by channel
    </Card>
  </Column>
</Columns>