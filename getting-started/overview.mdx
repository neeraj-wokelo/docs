---
title: "akta.pro API Overview"
description: "Introduction to the akta.pro API platform, its data products, and how to start building."
...
<Steps>
  ...
  <Step title="Make your first API request">
    Try company search endpoint to start with. Make sure to replace YOUR_API_KEY with the actual API key in the code snippets below.
...
<Columns cols={2}>
  <Column>
    <Card title="Company Data" icon="database" href="/docs/company-data/overview">
      75+ data points for 20M+ private and public companies globally
    </Card>
