...
| --- | --- | --- | --- |
| `query` | string | **Required** | Company name (e.g. `"Canva"`), website domain (e.g. `"canva.com"`), or UUID (e.g. `"3fa85f64-..."`). The API automatically identifies the input type and resolves it. |
