...
v1 authenticates with an Akta API key (`wk_...`), minted at [playground.akta.pro](https://playground.akta.pro) (sign up → API Keys). There are three ways to supply it, in precedence order:

```bash
# 1. Explicit flag
akta --api-key wk_...  company search Canva

# 2. Environment variable
export AKTA_API_KEY=wk_...

# 3. Stored (prompts, or --api-key)
akta login
```
