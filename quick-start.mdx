...
If you have company name as the starting point, you should first use [Company Search AP](company-search-doc)I to find the Akta UUID and then use the News Signals API.

If you have industry name as the starting point, you should first use [Industry Search API](https://docs.akta.pro/industry-search-api) to find the industry codes as per Akta's industry taxonomy and then use the News Signals API.
