...
<ParamField query="industry" type="string">
  Comma separated list of industry codes to filter articles by. See the complete list of industry codes here.
</ParamField>

<ParamField query="query" type="string">
  Topic name to search articles. Allows open-ended topic name.
</ParamField>
...
<ParamField query="type_list" type="string[]">
  Filter by news type. [Download Full List](https://playground.akta.pro/news-tags.csv)
...
<ResponseField name="types" type="array of objects">
